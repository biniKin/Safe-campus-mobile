...
import 'package:safe_campus/core/utls/time_formater.dart';
...
import 'package:safe_campus/features/sos/presentation/screens/home_trusted_contact_continer.dart';
...
import 'package:safe_campus/features/sos/presentation/screens/sos_home_container.dart';
      ...
      builder: (context, state) {
        return Scaffold(
          appBar: AppBar(
            ...
            // leading: Image.asset(ImagesString.appLogo, width: 10, height: 10),
            title: Text(
              "Safe Campus",
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return HomeTrustedContactContiner(
                        ...
                        onDelete: () {
                          ...
                          context.read<ContactListBloc>().add(
                            DeleteContactEvent(contact.email),
                          );
                        },
                        onTap: () {
                          showModalBottomSheet(
      ...
      child: Column(
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                colors: [Color(0xFF7E7FB9), Color(0xFF36374E)],
                begin: Alignment.topCenter,
                end: Alignment.bottomCenter,
              ),
              borderRadius: BorderRadius.circular(10),
