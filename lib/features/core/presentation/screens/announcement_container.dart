        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(announcementModel.title, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),), 
                Container(
                  ...
                  child: Text(announcementModel.status, style: TextStyle(color: Colors.redAccent),),
                ),
              ],
            ),
            // content
            ...
            Align(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 5,),
                  Text("at ${announcementModel.time.toString().split(' ')[1].split(":")[0]}"),
                ],
              )),
