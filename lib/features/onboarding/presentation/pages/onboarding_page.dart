...
import 'package:safe_campus/features/auth/presentation/pages/sign_in_page.dart';
...
class _OnboardingPageState extends State<OnboardingPage> {
  ...
  Future<void> completeOnboarding() async {
    ...
    Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_)=>SignInPage()), (route)=>true);
  }
